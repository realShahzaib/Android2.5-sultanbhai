...
import com.hybridproduct.apps.nearbystores.booking.controllers.parser.CFParser;
import com.hybridproduct.apps.nearbystores.booking.controllers.parser.VariantParser;
            ...
            for (int i = 0; i < json_array.length(); i++) {
                ...
                try {
                    ...
                    if (json_user.has("services")) {
                        ...
                        VariantParser pp = new VariantParser(services);
                        store.setVariants(pp.getVariants());
                    }
