    ...
    public void onBindViewHolder(OfferListAdapter.mViewHolder holder, int position) {
        ...
        /*if (data.get(position).getDistance() != null) {
            ...
            if (data.get(position).getDistance() > 0) {
                ...
                String symbole = com.hybridproduct.apps.nearbystores.AppController.utils.Utils.getDistanceBy(
                        data.get(position).getDistance()
                );
                String distance = com.hybridproduct.apps.nearbystores.AppController.utils.Utils.preparDistance(
                        data.get(position).getDistance()
                );
